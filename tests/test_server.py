...
class ServerTests(unittest.TestCase):
    ...
    def test_health_interface_and_conversation_cycle(self) -> None:
        ...
        self.assertIn("Assistant local · sources vérifiables", interface)
        self.assertIn("MAT-LM réfléchit…", interface)
        self.assertIn('placeholder="Message à MAT-LM…"', interface)
        self.assertNotIn("Je consulte les souvenirs utiles", interface)
